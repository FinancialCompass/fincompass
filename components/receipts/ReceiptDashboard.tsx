...
import { Clock, DollarSign, ShoppingBag, Tag, Calendar, MapPin, Phone, CreditCard, Receipt as ReceiptIcon } from 'lucide-react';
...
const ReceiptCard: React.FC<{ receipt: Receipt }> = ({ receipt }) => {
    const { metadata, transaction, items, summary, status } = receipt;
